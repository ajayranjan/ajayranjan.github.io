    ...
    return function (data, key) {
		...
		var paper=[
						...
						"details":"Design, Automation & Test in Europe Conference & Exhibition"},
					{
						...
						{
						"year":2016,
						"authors":"Youri Popoff., Florian Scheidegger., Michael Schaffner., Michael Gautschi., Frank K. G¡§urkaynak., Luca Benini.¢Ó",
						"title":"High-Efficiency Logarithmic Number Unit Design based on an Improved Cotransformation Scheme",
						"details":"ETH Z¨urich, 8092 Z¨urich, Switzerland, †Universit`a di Bologna, Italy978-3-9815370-7-9/DATE16/c 2016 EDAA"},
						{
						"year":2015,
